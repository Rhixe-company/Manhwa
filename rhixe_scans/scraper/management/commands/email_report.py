...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        comics = Comic.objects.filter(publish__range=(today_end, today_end))
        ...
        if comics:
            ...
            subject = (
                f"Comic Report for {today_start.strftime('%Y-%m-%d')} "
            ...
            self.stdout.write("No comics confirmed today.")
